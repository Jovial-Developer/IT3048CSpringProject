...
data class ComputerComponent(@SerializedName("ID") val id : Int, @SerializedName("index") var index : Int, @SerializedName("Price") var price : Int, @SerializedName("Name") var name: String, @SerializedName("Brand") var brand: String, @SerializedName("Model") var model: String, @SerializedName("Hide") var hide: Boolean, @SerializedName("AddToCart") var addtocart: Boolean){
